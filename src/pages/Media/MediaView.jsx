    ...
    <>
      <div>
        <div className="main-container mt-6 ">
          <div className=" bg-white dark:bg-gray-700 mx-1 pt-4 px-4 md:px-7 pb-7 rounded-sm">
            ...
            />
            <div className="mt-6 rounded-xl bg-white dark:bg-gray-800 p-3 md:p-6 shadow">
              {isGridView ? (
