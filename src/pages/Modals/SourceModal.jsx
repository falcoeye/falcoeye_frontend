...
import YoutubeView from "../Camera/components/YoutubeView";
...
const SourceModal = ({
  ...
  const openSliderModalHandler = useCallback(() => setSliderModal(true), []);
  const closeSliderModalHandler = useCallback(() => setSliderModal(false), []);
  ...
  const videoID = selectedCardUrl?.split("v=")[1]?.split("&")[0];
        ...
        >
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="max-w-4xl w-11/12 transform overflow-hidden rounded-2xl bg-white py-6 px-3 md:px-6  text-left align-middle shadow-xl transition-all">
