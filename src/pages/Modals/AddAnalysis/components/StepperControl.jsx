...
export default function StepperControl({
  ...
  return (
    <div className="mt-4 flex justify-around">
      <button
        onClick={() => handleClick()}
        className={`cursor-pointer rounded-xl border-2 border-slate-300  bg-white dark:bg-transparent dark:border-gray-800 py-2 px-4 font-semibold uppercase text-slate-400 transition duration-200 ease-in-out hover:bg-slate-700 hover:border-slate-700 hover:text-white  ${
